...
import input_data
#CA don't want mnist. mnist = input_data.read_data_sets('MNIST_data', one_hot=True)
...
# In[8]:
#CA: modified for RCV1
#CA: use ReLUs, per "Neural Variational Inference for Text Processing", Miao, Yu, Blunsom ICML 2016
network_architecture =     dict(n_hidden_recog_1=500, #CA okay: 1st layer encoder neurons
         n_hidden_recog_2=500, #CA okay: 2nd layer encoder neurons
         n_hidden_gener_1=500, #CA okay: 1st layer decoder neurons
         n_hidden_gener_2=500, #CA okay: 2nd layer decoder neurons
         #CA n_input=784, # MNIST data input (img shape: 28*28)
         #CA n_z=2)  # dimensionality of latent space
